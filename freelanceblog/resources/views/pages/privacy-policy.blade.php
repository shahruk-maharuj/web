...
<head>
    ...
    <title>Privacy Policy || Blogar - Personal Blog Template</title>
                    ...
                    <div class="col-lg-10 offset-lg-1">
                        <div class="content">
                            <div class="inner">
                                ...
                                <h3>About Blogar</h3>
                                <p class="subtitle-2 mb--40">In dapibus, nibh sit amet pulvinar convallis, massa nunc tincidunt nunc, a pretium risus nulla ut dui. Ut ut condimentum tellus, dapibus volutpat est. Integer ullamcorper iaculis blandit. Pellentesque id tempus urna. Quisque luctus cursus imperdiet. <a href="#">hello@Blogar.com</a></p>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-9 col-md-12">
                            <div class="copyright-left">
                                <div class="logo">
                                    <a href="index.html">
                                        <img class="dark-logo" src="assets/images/logo/logo-white.png" alt="Logo Images">
                                        <img class="light-logo" src="assets/images/logo/logo-white2.png" alt="Logo Images">
                                    </a>
                                </div>
